...
var wordsList   = ["pumpkin", "halloween", "spiders", "candycorn", "ghosts", "bats", "vampires", "witches", "goblins"];
...
var dashes = 0; // This will be the number of blanks we show based on the solution
...
function startGame() {
  ...
  dashes = lettersInChosenWord.length; // we cound the number of letters in the word

  console.log(chosenWord); // We print the solution in console (for testing)

  blanksAndSuccesses = []; //  here we *reset* the guess and success array at each round. 
  wrongGuesses = []; //  here we *reset* the wrong guesses from the previous round.
  ...
  var myPicElement = document.getElementById("hangimage").src = "assets/images/HM11.jpg";
...
function checkLetters(letter) {
  ...
  // If the letter doesn't exist at all...
    ...
    var url = document.getElementById("hangimage").src = "assets/images/HM" + numGuesses + ".jpg";
  }
}
